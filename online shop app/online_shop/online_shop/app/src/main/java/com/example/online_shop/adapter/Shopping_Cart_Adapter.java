...
public class Shopping_Cart_Adapter extends ArrayAdapter<Product> {

    Context context;
    List<Product> arrayListProducts;

    public Shopping_Cart_Adapter(@NonNull Context context, List<Product> arrayListProducts) {
        super(context, R.layout.shopping_cart_list_item,arrayListProducts);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.shopping_cart_list_item,null,true);

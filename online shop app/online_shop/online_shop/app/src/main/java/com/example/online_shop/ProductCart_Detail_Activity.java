...
public class ProductCart_Detail_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prodyct_cart_detail);
...
//===========================================================================
        ...
        btn_buy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent =Product_Buy_Activity.newIntent(ProductCart_Detail_Activity.this,buy_id,buy_title,buy_price,buy_photo);
...
//===========================================================================
        ...
        txt_id.setText(Shopping_Cart_Activity.productArrayList.get(position).getId());
        title.setText(Shopping_Cart_Activity.productArrayList.get(position).getTitle());
        describe.setText(Shopping_Cart_Activity.productArrayList.get(position).getDescribe());
        price.setText(Shopping_Cart_Activity.productArrayList.get(position).getPrice());
        txt_photo.setText(Shopping_Cart_Activity.productArrayList.get(position).getPhoto());
        owner.setText(Shopping_Cart_Activity.productArrayList.get(position).getOwner());
